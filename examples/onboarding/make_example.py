...
def render_with_pillow() -> None:
    ...
    values = {"First name*": "Priya", "Last name*": "Shah", "Date of birth*": "04/03/1975", "Email address": "priya.shah@example.com",
              "Phone number": "07000 12345678", "Account type*": "Personal", "Address line 1": "48 Greek Street", "Address line 2": "Soho",
